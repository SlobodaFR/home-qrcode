...
| 2 | `auth` | OAuth2 Authorization Code flow via auth.sloboda.fr, JwtAuthGuard (JWKS), httpOnly cookies, logout, disconnect webhook, user upsert | `repo-setup` | in-progress |
